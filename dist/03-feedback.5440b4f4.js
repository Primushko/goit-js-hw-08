...
emailInput.addEventListener("input", (0, _lodashThrottleDefault.default)(saveStateToLocalStorage, 500));
messageInput.addEventListener("input", (0, _lodashThrottleDefault.default)(saveStateToLocalStorage, 500));
